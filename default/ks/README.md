...
* **[ks-el9-00def.ks](ks-el9-00def.ks)**, **[ks-el8-00def.ks](ks-el8-00def.ks)**, **[ks-el7-00def.ks](ks-el7-00def.ks)** - Default Headless with local /home and /opt, no OpenSCAP, STIG Ansible Playbooks (**default**)
* **[ks-el9-01noluks.ks](ks-el9-01noluks.ks)**, **[ks-el8-01noluks.ks](ks-el8-01noluks.ks)**, **[ks-el7-01noluks.ks](ks-el7-01noluks.ks)** - As Headless (default), with local /home and /opt, no OpenSCAP, STIG Ansible Playbooks, **but** no LUKS volume encryption (e.g., block store is already hardware/host encrypted *'at rest'*)
