...
* **`./elmedia0/default/`** (see [./default/](./default/)) - Default elmedia0 [Boot Menu](./default/) and Anaconda-Installer [Kickstart files/functions/includes](./ks/)  -- overridden by those files in `./elmedia0/custom/` (and `./elmedia0.custom/custom/`)
