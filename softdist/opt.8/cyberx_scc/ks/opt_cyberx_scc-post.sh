#
#       /opt/cyberx_scc/opt_cyberx_scc-post.sh
#
...
if [ -r "/opt/${myOpt}/scc-${sccVer}_${sccVen}_x86_64/scc-${sccVer}_rhel${elVerRel}.x86_64.rpm" ] ;
       	/bin/rpm -Uhv "/opt/${myOpt}/scc-${sccVer}_${sccVen}_x86_64/scc-${sccVer}_rhel${elVerRel}.x86_64.rpm"
fi
